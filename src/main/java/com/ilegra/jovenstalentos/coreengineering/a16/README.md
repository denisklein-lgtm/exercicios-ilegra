## Design Pattern (comportamentais): Command
...
Não é necessario validar o saldo antes de se realizarem operações de saque, é permitido saques mesmo que ocasionem o saldo ser negativado.
```